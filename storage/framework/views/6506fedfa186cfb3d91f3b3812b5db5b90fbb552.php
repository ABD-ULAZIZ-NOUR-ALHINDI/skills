...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Tomouh</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="https://tomouh.online/">tomouh</a> on <a class="text-light bb" target="_blank" href="https://tomouh.online/">Tomouh.online</a>
            </div>
          </div>
            </div>
...
<?php /**PATH /home/u275401563/domains/tomouh.online/public_html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>